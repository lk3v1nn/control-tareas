# Repositorio base del sistema de tareas en React.js

Para empezar clona este repositorio (`git clone`), instalar sus dependencias (`npm i`) y ejecutar la aplicación (`npm start`).
